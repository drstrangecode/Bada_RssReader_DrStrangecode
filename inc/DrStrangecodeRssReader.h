#ifndef _DRSTRANGECODERSSREADER_H_
#define _DRSTRANGECODERSSREADER_H_
...
public:
	...
	/**
	 * [DrStrangecodeRssReader] application must have a factory method that creates an instance of itself.
	 */
	static Osp::App::Application* CreateInstance(void);


public:
	DrStrangecodeRssReader();
	~DrStrangecodeRssReader();
